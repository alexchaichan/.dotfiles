...
if system == 'Darwin':
    ...
    path = os.pathsep + '~/.local/bin:~/.pyenv/bin:~/.pyenv/shims:/usr/local/bin:/usr/local/sbin:~/bin:~/.cargo/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin:/opt/X11/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands'
...
#c.url.default_page = ("C:\\Users\\a.chaichan\\AppData\\Roaming\\qutebrowser\\config\\startpages\\search\\startpage.html")
#c.url.start_pages = ("C:\\Users\\a.chaichan\\AppData\\Roaming\\qutebrowser\\config\\startpages\\search\\startpage.html")
